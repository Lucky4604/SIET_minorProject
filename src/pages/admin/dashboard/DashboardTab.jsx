                    ...
                    <div className='  px-4 md:px-0 mb-16'>
                        ...
                        <div className=" flex justify-end">
                            <button
                                ...
                                type="button"
                                className="focus:outline-none text-white bg-gradient-to-r from-blue-800 to-indigo-900 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2"  > <div className="flex gap-2 items-center">
