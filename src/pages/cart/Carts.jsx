...
import { deleteFromCart } from '../../reduxs/cartSlice'
...
const Carts = () => {
  ...
  const buyNow = async () => {
    ...
    const addressInfo = {
     ...
     var options = {
      key: "rzp_test_nnmQc2Uhbx3wxl",
      key_secret: "QDOMatKprsfJ3rCyDrv3aroW",
  ...
  return (
    <Layout >
    <div className="h-screen bg-gray-100% pt-5 mb-[50%] ">
          ...
          {cartItems.map((item,index)=>{
            ...
            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
              <div className="mt-5 sm:mt-0">
                ...
                <p className="mt-1 text-xs font-semibold text-gray-700" >₹1{item.price}</p>
              </div>
